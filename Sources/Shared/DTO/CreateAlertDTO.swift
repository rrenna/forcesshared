...
public struct CreateAlertDTO: Codable {
    ...
    public init(name: String, value: String, group: String?, rssURL: String, keywords: [String], thumbnailURL: String? = nil, headerImageURL: String? = nil, steamGameURL: String? = nil, relatedGameSystems: [String]? = nil, repositoryURL: String? = nil, repositoryTrackCommits: Bool? = nil) {
